...
| 12 | `Recent Papers (2024-2026)` | 3 recent papers (with date/year, journal name) |
| 13 | `Top Cited Papers` | 3 top cited landmark papers (with date/year, journal name, citations) |
...
| 17 | `Google Scholar Tags` | Extracted Google Scholar / OpenAlex research interest tags |
